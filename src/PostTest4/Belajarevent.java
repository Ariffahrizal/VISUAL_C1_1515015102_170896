...
//            JOptionPane.showMessageDialog(null, "Nama belum terisi", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
//            nama.requestFocus();
//        }
//        else if(telp.getText().length()==0){
//            JOptionPane.showMessageDialog(null, "No Telpon belum terisi", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
//            telp.requestFocus();
//        }
//        else if(alamat.getText().length()==0){
//            JOptionPane.showMessageDialog(null, "Alamat belum terisi", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
//            alamat.requestFocus();
//        }
//        else if (berat.getText().equals(0) ) {
//            JOptionPane.showMessageDialog(null, "Berat barang tidak boleh 0", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
//            berat.requestFocus();
//        }
//        else{
...
//        }
        ...
        if (reguler.isSelected()) {
           ...
           Total   = ((Hawal-VDiskon)*1.5F);
            ...
            JOptionPane.showMessageDialog(null, "Jenis Jasa Pengiriman belum terisi", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
...
//        setVisible(true);
    ...
    private void namaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_namaCaretUpdate
        // TODO add your handling code here:
        if(nama.getText().length() != 0 && telp.getText().length() != 0 && alamat.getText().length() != 0 && berat.getText().equals(0)){
            proses.setEnabled(true);
        }
        else{
    ...
    private void telpCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_telpCaretUpdate
        // TODO add your handling code here:
        if(telp.getText().length() != 0 && nama.getText().length() != 0 && alamat.getText().length() != 0 && berat.getText().equals(0)){
            proses.setEnabled(true);
        }
        else{
            proses.setEnabled(false);
    ...
    private void alamatCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_alamatCaretUpdate
        // TODO add your handling code here:
        if(alamat.getText().length() != 0 && nama.getText().length() != 0 && telp.getText().length() != 0 && berat.getText().equals(0)){
            proses.setEnabled(true);
        }
        else{
            proses.setEnabled(false);
...
//            proses.setEnabled(true);
//        }
          if (berat.getText().equals("0")||berat.getText().length()==0) {
            proses.setEnabled(false);
          }
          else{
              proses.setEnabled(true);
        ...
        berat.addKeyListener(new KeyAdapter(){
            public void keyTyped(KeyEvent e){
                ...
                if (((karakter < '0') || (karakter > '9')) && (karakter != '.')) {
                    JOptionPane.showMessageDialog(null, "Berat barang wajib diisi integer dan tidak boleh 0", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
                    berat.requestFocus();
                    e.consume();
                }
            }
        ...
        telp.addKeyListener(new KeyAdapter(){
            public void keyTyped(KeyEvent e){
                ...
                if (!((karakter1 >= '0') && (karakter1 <= '9')))  {
                    JOptionPane.showMessageDialog(null, "No Telepon wajib diisi integer", "Peringatan", JOptionPane.INFORMATION_MESSAGE);
                    berat.requestFocus();
                    e.consume();
                }
            }
